...
public class Country {
    ...
    public static final String[] TAGS = {"Asthma","Aneurysms","Bleeding Disorders","Blood Clot",
            "Chronic Kidney Disease","Diabetes","Down Syndrome","Epilepsy","Hearing Impairment","Heart Patients",
            "Invisible Disabilities","Marfan Syndrome","Organ Transplants","Seizure Disorder","Substance Use Disorders",
            "Vision Impairment","Bee Sting","Dairy","Egg","Latex","Metal Allergy","Nut", "Peanut", "Penicillin","Shellfish",
            "Wheat", "Galactosemia", "Celiac Disease","Autism","Alzheimer's","Dementia","Mental Health","Blood Thinners","EpiPen",
            "Thoracic cavity","Abdominal cavity","Allergy","pain","water","blood","bones","heart","lungs","intestines","stomach",
            "skin","hairs","pain-killers","cough","flu","vomit","bleeding","blood-pressure","hypertension","Anemia","Asthma",
            "Asplenia","Autism","Cerebrovascular incident","Chemotherapy","Blood type", "Dementia","Adrenal insufficiency",
            "Advance Medical","Diabetic", "Epilepsy","Hemophilia","Hypoglycemia","Hypopituitarism","Lymphedema risk","Porphyria (acute)",
            "Seizure disorders","Situs inversus","Von Willebrand Disease","Aspirin (Salicylic Acid)","Quinine (Qualaquin)",
            "Opiates (Oxycontin, Morphine, Codeine)","Myriocin","Penicillin","Digoxin","Paclitaxel (Taxol)","Vincristine & Vinblastine",
            "Antibiotics","Chemotherapy","Pain management","Hallucinogenics","Cancer","Tumor","fatigue","ultrasound",
            "eyesight","sneezing","X-ray","memography","MRI","Digestive Disorders","Blood Disorders","Skin Disorders"};
}
